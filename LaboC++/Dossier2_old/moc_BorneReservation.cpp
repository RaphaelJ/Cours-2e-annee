...
static QMetaObjectCleanUp cleanUp_BorneReservation("BorneReservation",
						   &BorneReservation::
						   staticMetaObject);
...
{
    if (qApp)
	return qApp->translate("BorneReservation", s, c,
...
QMetaObject *BorneReservation::staticMetaObject()
{
	...
	{ "AffichagePublicite", 1, param_slot_4 };
    ...
    metaObj = QMetaObject::new_metaobject("BorneReservation", parentObject,
					  slot_tbl, 6, 0, 0,
...
bool BorneReservation::qt_invoke(int _id, QUObject * _o)
{
	...
	break;
    case 3:
	AffichageMenu((const char *) static_QUType_charstar.get(_o + 1));
	break;
    case 4:
	AffichagePublicite((const char *) static_QUType_charstar.
			   get(_o + 1));
	break;
    case 5:
	languageChange();
...
bool BorneReservation::qt_static_property(QObject *, int, int, QVariant *)
{
    return FALSE;
}
#endif				// QT_NO_PROPERTIES
