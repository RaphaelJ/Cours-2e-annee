...
prompt'Insertion des données dans la base de données INFOSOFT';
prompt'*******************************************************';
...
values ('123456', 'CURTIS', 'Tony',	 to_date('1930-02-17' ,'YYYY-MM-DD'),'1',
	'rue Egalité, 18','4430','ANS',70000); 
insert into employes
(NumSecu, Nom, Prenom, DateNais, Sexe, Adresse, CodePostal, Commune,Bareme)
values ('451278', 'CELARIE', 'Clémentine',
...
values ('192357', 'LHERMITTE', 'Thierry',
	...
	'rue Vieux Pré, 6','4050','CHAUDFONTAINE',
	56700); 
insert into employes
(NumSecu, Nom, Prenom, DateNais, Sexe, Adresse, CodePostal, Commune,Bareme)
