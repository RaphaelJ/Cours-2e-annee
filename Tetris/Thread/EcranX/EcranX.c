...
int setCouleurCrayon(TC *p,int couleur)
{
  ...
  switch(couleur)
  {
    case NOIR      : c = p->Noir.pixel; break;
    case BLANC     : c = p->Blanc.pixel; break; 
    case ROUGE     : c = p->Rouge.pixel; break;
    case BLEU      : c = p->Bleu.pixel; break;
    case VERT      : c = p->Vert.pixel; break;
    case JAUNE     : c = p->Jaune.pixel; break;
    case BRUN      : c = p->Brun.pixel; break;
    case GRIS      : c = p->Gris.pixel; break;
    case MAGENTA   : c = p->Magenta.pixel; break;
    case CYAN      : c = p->Cyan.pixel; break;
    default        : c = p->Noir.pixel; break;
  }
